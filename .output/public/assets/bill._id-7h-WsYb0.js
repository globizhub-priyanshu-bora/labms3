import{j as t,a7 as f,w as u,b as v,B as c,t as x}from"./main-7-PV94Mj.js";import{L as y}from"./Layout-BjyUM3rL.js";import{A as N}from"./arrow-left-OCQw69Ba.js";import{P as j}from"./printer-B2_J5kfY.js";import{D as w}from"./download-CP9v0xGW.js";function P(){const l=f.useLoaderData(),m=u();if(!l.success||!l.data)return t.jsx("div",{className:"min-h-screen bg-gray-50 flex items-center justify-center",children:t.jsxs("div",{className:"text-center",children:[t.jsx(v,{className:"w-16 h-16 text-red-500 mx-auto mb-4"}),t.jsx("p",{className:"text-xl text-gray-700 mb-4",children:"Bill not found"}),t.jsx("p",{className:"text-sm text-gray-600 mb-6",children:l.error||"Unable to load the requested bill"}),t.jsx(c,{onClick:()=>m({to:"/lab-management"}),children:"Back to Lab Management"})]})});const{bill:a,patient:n,tests:r}=l.data,s=l.lab,p=()=>{const e=document.getElementById("bill-print-content");if(!e)return;const i=window.open("","","width=900,height=700");i&&(i.document.write(`
      <!DOCTYPE html>
      <html>
        <head>
