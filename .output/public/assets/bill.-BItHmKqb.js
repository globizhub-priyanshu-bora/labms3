import{j as e,a4 as j,u as f,b as u,B as x}from"./main-BeIBSn2v.js";import{L as N}from"./Layout-jiilGqhg.js";import{A as v}from"./arrow-left-D4ChJQ2j.js";import{P as w}from"./printer-DbpEWcNQ.js";import{D as A}from"./download-C4rb5vqj.js";import"./user-C7G1wQVG.js";function h(r){if(r===0)return"Zero";const o=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"],n=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],s=["Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"];function a(t){return t===0?"":t<10?o[t]:t<20?s[t-10]:t<100?n[Math.floor(t/10)]+(t%10!==0?" "+o[t%10]:""):o[Math.floor(t/100)]+" Hundred"+(t%100!==0?" "+a(t%100):"")}if(r<1e3)return a(r);if(r<1e5){const t=Math.floor(r/1e3),d=r%1e3;return a(t)+" Thousand"+(d!==0?" "+a(d):"")}if(r<1e7){const t=Math.floor(r/1e5),d=r%1e5;return a(t)+" Lakh"+(d!==0?" "+h(d):"")}return"Number too large"}function T(){const r=j.useLoaderData(),o=f();if(!r.success||!r.data)return e.jsx("div",{className:"min-h-screen bg-gray-50 flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(u,{className:"w-16 h-16 text-red-500 mx-auto mb-4"}),e.jsx("p",{className:"text-xl text-gray-700 mb-4",children:"Bill not found"}),e.jsx("p",{className:"text-sm text-gray-600 mb-6",children:r.error||"Unable to load the requested bill"}),e.jsx(x,{onClick:()=>o({to:"/lab-management"}),children:"Back to Lab Management"})]})});const{bill:n,lab:s,patient:a,tests:t}=r.data,d=l=>{if(!l)return"-";const i=new Date(l);return`${i.toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})} ${i.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0})}`},c=parseFloat(n.totalAmount),m=c*parseFloat(n.discount||"0")/100,p=(c-m)*parseFloat(n.tax||"0")/100,g=parseFloat(n.finalAmount),b=h(Math.floor(g))+" Rupees",y=()=>{const l=document.getElementById("bill-print-content");if(!l)return;const i=window.open("","","width=1000,height=800");if(!i)return;i.document.write(`
      <!DOCTYPE html>
      <html>
        <head>
          <title>Bill - ${n.invoiceNumber}</title>
