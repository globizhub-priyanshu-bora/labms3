...
import { c as createLucideIcon, B as Button, X, g as getCurrentUser, $ as logoutUser } from "./router-CekfRpIN.mjs";
  ...
  return /* @__PURE__ */ jsx("nav", { className: "bg-white border-b border-gray-300 sticky top-0 z-40", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-16", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex items-center gap-1", children: [
        user.isAdmin ? /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
