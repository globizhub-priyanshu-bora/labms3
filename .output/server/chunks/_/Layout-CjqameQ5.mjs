...
import { c as createLucideIcon, X, g as getCurrentUser, a2 as getLabInfo, a3 as logoutUser } from "./router-DU3091Rk.mjs";
...
const Navigation = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("nav", { className: "bg-white border-b border-gray-200 sticky top-0 z-40", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-16", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden lg:flex items-center gap-1", children: menuItems.map((item, index) => {
          if (item.type === "dropdown") {
            return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              showAdminDropdown && /* @__PURE__ */ jsxs("div", { className: "absolute left-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg py-2 z-50", children: [
                ...
                /* @__PURE__ */ jsxs(Link, { to: "/admin/dashboard", className: "block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "hidden sm:inline text-sm font-medium text-gray-900", children: user.name.split(" ")[0] })
                ]
              }
            ),
            showUserMenu && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg py-2 z-50", children: [
              /* @__PURE__ */ jsxs("div", { className: "px-4 py-2 border-b border-gray-200 text-xs text-gray-500", children: [
                /* @__PURE__ */ jsx("p", { children: user.email }),
                /* @__PURE__ */ jsx("p", { className: "text-blue-600 font-semibold", children: user.isAdmin ? "Administrator" : "User" })
              ] }),
              /* @__PURE__ */ jsxs(
                "button",
                {
      ...
      isMobileMenuOpen && /* @__PURE__ */ jsx("div", { className: "lg:hidden pb-4 border-t border-gray-200 space-y-1", children: menuItems.map((item, index) => {
        if (item.type === "dropdown") {
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(item.icon, { className: "w-4 h-4" }),
                  item.label,
                  /* @__PURE__ */ jsx(ChevronDown, { className: `w-4 h-4 ml-auto transition-transform ${showAdminDropdown ? "rotate-180" : ""}` })
                ]
              }
            ),
            showAdminDropdown && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs(Link, { to: "/dashboard", className: "ml-4 block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(LayoutDashboard, { className: "w-4 h-4" }),
                "Dashboard"
              ] }),
              /* @__PURE__ */ jsxs(Link, { to: "/admin/dashboard", className: "ml-4 block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Users, { className: "w-4 h-4" }),
                "User Management"
              ] })
            ] })
    ...
    labInfo && /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-200 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-gray-900", children: labInfo.name }),
        /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-600 mt-0.5", children: [
          "Reg. No: ",
          labInfo.registrationNumber || "N/A"
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-600", children: /* @__PURE__ */ jsx("p", { children: labInfo.addressLine1 }) })
    ] }) }) })
  ] });
};
