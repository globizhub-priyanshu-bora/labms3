...
import { x as Route$7, y as useToast, B as Button, X, z as deleteDoctor, A as searchDoctors, D as registerDoctor, E as updateDoctor, F as getAllDoctors } from "./router-C5ryUzyF.mjs";
import { L as Label } from "./label-BHAEFp3i.mjs";
...
function DoctorManagement() {
  ...
  return /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    ...
    isAddModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow-lg p-6 max-w-md w-full mx-4", children: [
    ...
    isEditModalOpen && selectedDoctor && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow-lg p-6 max-w-md w-full mx-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-4", children: [
