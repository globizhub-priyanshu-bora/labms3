import { createRouter, createRootRoute, createFileRoute, lazyRouteComponent, redirect, HeadContent, Scripts, useNavigate } from "@tanstack/react-router";
import { jsxs, jsx } from "react/jsx-runtime";
import React, { forwardRef, createElement, useState, useCallback, createContext } from "react";
...
import { and, eq, isNull, desc, count, inArray, ilike, ne, or } from "drizzle-orm";
import { z } from "zod";
import { d as db, b as billSchema, l as labSchema, p as patientSchema, c as doctorSchema, t as testSchema, a as patientTestsSchema, e as testParamSchema, k as testResultsSchema, u as userSchema, g as getSessionFromRequest, h as getSession, f as deleteSession, i as updateSession, j as createSession } from "./session-manager-CtAttBZO.mjs";
import { g as getLabIdFromRequest, a as getUserFromRequest } from "./helpers-BpXhOhAI.mjs";
...
const ToastProvider = ({ children }) => {
  ...
  const showToast2 = useCallback((message, type = "info", duration = 3e3) => {
  ...
  return /* @__PURE__ */ jsxs(ToastContext.Provider, { value: { showToast: showToast2, hideToast }, children: [
    children,
    /* @__PURE__ */ jsx("div", { className: "fixed bottom-4 right-4 z-50 space-y-2 max-w-sm pointer-events-none", children: toasts.map((toast2) => /* @__PURE__ */ jsx(
      ToastComponent,
      {
        toast: toast2,
        onRemove: () => hideToast(toast2.id)
      },
      toast2.id
    )) })
  ] });
};
function ToastComponent({ toast: toast2, onRemove }) {
  const bgColorClass = {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `border ${bgColorClass} rounded-lg p-4 shadow-lg flex items-start gap-3 animate-in fade-in slide-in-from-bottom-4 duration-300 pointer-events-auto`, children: [
    ...
    /* @__PURE__ */ jsx("p", { className: `${textColorClass} text-sm font-medium flex-1`, children: toast2.message }),
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: onRemove,
...
const appCss = "/assets/styles-1Z4_oEVa.css";
...
function createToastElement(message, type) {
  ...
  toast2.className = `fixed px-6 py-4 rounded-lg shadow-lg font-medium text-white z-50 animate-fadeIn`;
  const colors = {
...
const toast = {
  ...
  error: (message, options) => showToast(message, "error", { duration: 4e3, ...options }),
  info: (message, options) => showToast(message, "info", options),
  warning: (message, options) => showToast(message, "warning", options)
};
const Route$e = createFileRoute("/lab-setup")({
  component: LabSetup
});
function LabSetup() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-3xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-2xl p-8", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { className: "block text-sm font-semibold text-gray-900 mb-2", children: "Lab Registration Document / Photo" }),
          /* @__PURE__ */ jsxs("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition-colors", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "file",
            ...
            /* @__PURE__ */ jsxs("label", { htmlFor: "photo-input", className: "cursor-pointer", children: [
              /* @__PURE__ */ jsx(Upload, { className: "w-8 h-8 text-gray-400 mx-auto mb-2" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: "Click to upload or drag and drop" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "PNG, JPG, or PDF (Max 5MB)" })
            ] })
          ] }),
          photoPreview && /* @__PURE__ */ jsxs("div", { className: "mt-4 relative", children: [
            /* @__PURE__ */ jsx("div", { className: "w-full h-32 bg-gray-100 rounded-lg overflow-hidden border border-gray-200", children: photoPreview.includes("pdf") ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center h-full text-gray-600", children: [
              /* @__PURE__ */ jsx(FileText, { className: "w-8 h-8 mr-2" }),
...
const $$splitComponentImporter$d = () => import("./dashboard-BaZN2gws.mjs");
const Route$d = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./index-leS-Ulas.mjs");
...
const getAllTestParameters = createServerFn({
  ...
  try {
    ...
    try {
      ...
      console.error("Error getting lab ID:", error);
      throw new Error(error instanceof Error ? error.message : "Failed to load lab context");
    }
...
const $$splitComponentImporter$b = () => import("./index-Cl8oiGwu.mjs");
const Route$b = createFileRoute("/tests/")({
...
const $$splitComponentImporter$a = () => import("./index-RtfYrAln.mjs");
const Route$a = createFileRoute("/test-parameters/")({
...
const $$splitComponentImporter$9 = () => import("./index-CkkuNLgQ.mjs");
const Route$9 = createFileRoute("/lab-management/")({
...
const $$splitComponentImporter$8 = () => import("./index-C9gnL5wd.mjs");
const Route$8 = createFileRoute("/lab-details/")({
...
const $$splitComponentImporter$7 = () => import("./index-BiqLZpNN.mjs");
...
const $$splitComponentImporter$6 = () => import("./_testId-CjhZ-VFV.mjs");
...
const $$splitComponentImporter$5 = () => import("./register-C8rVnhXu.mjs");
...
const $$splitComponentImporter$4 = () => import("./_id-sIECmPBS.mjs");
...
const $$splitComponentImporter$3 = () => import("./_id-B2MouE0q.mjs");
...
const $$splitComponentImporter$2 = () => import("./user-management-BPrNHGw6.mjs");
...
const getLabInfo_createServerFn_handler = createSsrRpc("d78709e5b3dd094a181e5b9137b2b27e1883bd2ce0a4c4fd258eb175dd7eeeca");
...
const $$splitComponentImporter$1 = () => import("./bill._id-DfXB0Thf.mjs");
...
const $$splitComponentImporter = () => import("./bill.-DaRGvdCM.mjs");
...
const LabSetupRoute = Route$e.update({
  id: "/lab-setup",
  path: "/lab-setup",
...
const TestsIndexRoute = Route$b.update({
  id: "/tests/",
  path: "/tests/",
  getParentRoute: () => Route$f
});
const TestParametersIndexRoute = Route$a.update({
  id: "/test-parameters/",
  path: "/test-parameters/",
  getParentRoute: () => Route$f
});
const LabManagementIndexRoute = Route$9.update({
  id: "/lab-management/",
  path: "/lab-management/",
  getParentRoute: () => Route$f
});
const LabDetailsIndexRoute = Route$8.update({
  id: "/lab-details/",
  path: "/lab-details/",
  getParentRoute: () => Route$f
});
...
const AdminUserManagementRoute = Route$2.update({
...
const routerBYOHKi2s = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  A: Route$6,
  B: Button,
  C: updateTestResult,
  D: createTestResult,
  E: Route$5,
  F: searchPatientByPhone,
  G: createPatientWithTests,
  H: Route$4,
  I: Route$3,
  J: searchBills,
  K: getAllBills,
...
export {
  ...
  getAllDoctors as H,
  Route$6 as I,
  updateTestResult as J,
  createTestResult as K,
  Label as L,
  Mail as M,
  Route$5 as N,
  searchPatientByPhone as O,
  Phone as P,
  createPatientWithTests as Q,
  Route$b as R,
  Route$4 as S,
  Route$3 as T,
  searchBills as U,
  ...
  Route as a1,
  logoutUser as a2,
  routerBYOHKi2s as a3,
  calculateTestPrice as b,
  createLucideIcon as c,
  deleteTest as d,
  getAllTestParameters as e,
  createTest as f,
  getCurrentUser as g,
  getAllTests as h,
  Route$a as i,
